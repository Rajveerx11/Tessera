 ...
 *
 * The plaintext API key is never sent over IPC; `hasApiKey` is the boolean
 * signal the UI uses to render "Key set / Key missing" badges.
 */
...
/**
 * Arguments accepted by `save_provider_config` - mirrors `SaveProviderArgs` in
